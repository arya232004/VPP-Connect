...
const Sidebar = ({ collapsed, setCollapsed, mobile, handleResize }) => {
    ...
    >
      ...
      >
        {[
          ...
          { to: "/submissions", icon: <Notebook />, label: "Submissions" },
          { to: "/microblogging", icon: <SquarePen />, label: "Microblogging" },
          { to: "/chat", icon: <MessageCircleMore />, label: "Chat" },
          { to: "/latestcourseupdate", icon: <NotebookPen />, label: "Course Updates" },
          { to: "/zlibrary", icon: <Book />, label: "Z-Library" },
        ].map(({ to, icon, label }) => (
          <NavLink
            key={to}
            to={to}
